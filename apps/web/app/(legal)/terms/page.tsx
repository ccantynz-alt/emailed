  ...
  return (
    <Box className="max-w-4xl mx-auto">
        ...
        <Card className="mb-4 border-red-500/30 bg-red-500/5">
          <CardContent className="p-4">
            <Text className="font-semibold text-red-600 uppercase text-sm">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ALECRAE&apos;S TOTAL AGGREGATE LIABILITY FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR THE SERVICE SHALL NOT EXCEED THE AMOUNTS PAID BY YOU TO ALECRAE IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.
            </Text>
          </CardContent>
        </Card>
        <Sub label="(a)">IN NO EVENT SHALL ALECRAE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, BUSINESS OPPORTUNITIES, GOODWILL, OR REVENUE, REGARDLESS OF THE THEORY OF LIABILITY.</Sub>
        <Sub label="(b)">ALECRAE SHALL NOT BE LIABLE FOR DAMAGES ARISING FROM (i) AI CLASSIFICATION ERRORS, INCLUDING LEGITIMATE EMAILS CLASSIFIED AS SPAM OR SPAM REACHING YOUR INBOX; (ii) DELIVERABILITY OUTCOMES, INCLUDING EMAILS BEING REJECTED, DELAYED, OR FILTERED BY RECIPIENT MAIL SERVERS; (iii) CONTENT OF EMAILS SENT THROUGH THE SERVICE; (iv) ACTIONS TAKEN BY THIRD-PARTY EMAIL PROVIDERS; OR (v) UNAUTHORIZED ACCESS TO YOUR ACCOUNT WHERE SUCH ACCESS RESULTED FROM YOUR FAILURE TO SECURE YOUR CREDENTIALS.</Sub>
        <Sub label="(c)">THE LIMITATIONS IN THIS SECTION APPLY EVEN IF ALECRAE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES AND EVEN IF A REMEDY FAILS OF ITS ESSENTIAL PURPOSE.</Sub>
      ...
      <Section number="15" title="Dispute Resolution and Arbitration">
        ...
        <Sub label="(c) Class Action Waiver.">YOU AND ALECRAE AGREE THAT EACH PARTY MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, CONSOLIDATED, OR REPRESENTATIVE ACTION. The arbitrator may not consolidate more than one person&apos;s claims and may not preside over any form of representative or class proceeding.</Sub>
