  ...
  async (c) => {
    ...
    return c.json({
      data: {
        ...
        openHourDistribution: engagement.openHourDistribution,
        openDayDistribution: engagement.openDayDistribution,
        peakOpenHour: engagement.peakOpenHour,
        peakOpenDay: engagement.peakOpenDay,
        lastInteractionAt: engagement.lastInteractionAt?.toISOString() ?? null,
