...
const GOOGLE_REDIRECT_URI = process.env["GOOGLE_REDIRECT_URI"] ?? "https://api.vienna.com/v1/auth/callback/google";
...
const MS_REDIRECT_URI = process.env["MICROSOFT_REDIRECT_URI"] ?? "https://api.vienna.com/v1/auth/callback/microsoft";
